...
import com.vaadin.flow.smart.examples.form.ExampleSigUpSmartForm;
import com.vaadin.flow.smart.view.side.signup.AbstractSignUpFormByImageSmartView;
import com.vaadin.flow.theme.lumo.LumoUtility;
import jakarta.annotation.Nonnull;
import jakarta.annotation.Nullable;

@PageTitle("ExampleSignUpFormByImageSmartView")
@Route(value = "example/signup-form-by-image-smart-view")
@AnonymousAllowed
@SuppressWarnings("unused")
public class ExampleSignUpFormByImageSmartView
        extends AbstractSignUpFormByImageSmartView<FlexLayout, ExampleSigUpSmartForm> {
