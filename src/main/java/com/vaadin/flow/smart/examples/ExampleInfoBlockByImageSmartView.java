...
import com.vaadin.flow.smart.view.side.block.infoblock.AbstractInfoBlockByImageSmartView;
import com.vaadin.flow.theme.lumo.LumoUtility;
import jakarta.annotation.Nonnull;
import jakarta.annotation.Nullable;

@PageTitle("ExampleInfoBlockByImageSmartView")
@Route(value = "example/infoblock-by-image-smart-view")
@AnonymousAllowed
@SuppressWarnings("unused")
public class ExampleInfoBlockByImageSmartView
        extends AbstractInfoBlockByImageSmartView<FlexLayout, ExampleInfoBlockSmartComponent> {
